...
export const ScheduleSection = memo(function ScheduleSection() {
  const { ref, isInView } = useIntersectionObserver({ once: true, amount: 0.08 });

  return (
    <section id="horarios" ref={ref} className="section-y bg-black">
      <div className="container-page">
        <SectionTitle
          eyebrow="Horarios 2026"
          title="A qué hora entrena tu grupo"
          subtitle="Mañana y tarde, de lunes a sábado. Si tu horario no encaja con ninguno, escríbenos y lo miramos."
          isInView={isInView}
        />
